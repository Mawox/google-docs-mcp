...
if (oauthProxy) {
  ...
  // redirectToUpstream() doesn't add access_type=offline, so Google
  // never returns a refresh token. Without it the access token expires
  // after 1h and all API calls fail.
